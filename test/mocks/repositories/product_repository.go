...
func (_m *ProductRepository) Delete(ctx context.Context, product models.Product) error {
...
func (_m *ProductRepository) GetAll(ctx context.Context) ([]models.Product, error) {
	ret := _m.Called(ctx)
...
func (_m *ProductRepository) GetByID(ctx context.Context, id uuid.UUID) (models.Product, error) {
...
func (_m *ProductRepository) Post(ctx context.Context, product models.Product) error {
	ret := _m.Called(ctx, product)
...
func (_m *ProductRepository) Update(ctx context.Context, product models.Product) error {
	ret := _m.Called(ctx, product)

...
func (_m *ProductController) Delete(_a0 *fiber.Ctx) error {
	ret := _m.Called(_a0)
...
func (_m *ProductController) GetAll(_a0 *fiber.Ctx) error {
	ret := _m.Called(_a0)
...
func (_m *ProductController) GetByID(_a0 *fiber.Ctx) error {
	ret := _m.Called(_a0)
...
func (_m *ProductController) Post(_a0 *fiber.Ctx) error {
	ret := _m.Called(_a0)
...
func (_m *ProductController) Update(_a0 *fiber.Ctx) error {
	ret := _m.Called(_a0)
